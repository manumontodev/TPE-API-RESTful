...
$router->addRoute('ventas/:id_venta',     'GET',      'SaleApiController',    'showSale');
// metodos ABM ventas
$router->addRoute('ventas',     'POST',      'SaleApiController',    'addSale');
$router->addRoute('ventas/:id_venta',     'PUT',      'SaleApiController',    'updateSale');
$router->addRoute('ventas/:id_venta',     'DELETE',      'SaleApiController',    'deleteSale');
